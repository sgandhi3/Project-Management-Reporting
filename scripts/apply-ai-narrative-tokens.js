...
const TARGETS = {
  'ppt/slides/slide2.xml': [
    ...
    ['Majority of the PDM defects are configuration', '{{AI_PDM_DEFECT_SUMMARY}}'],
    ['44 open defects remain in', '{{AI_DEFECT_TRIAGE_STATUS}}'],
  ],
  'ppt/slides/slide3.xml': [
    ['Overall PDM SIT testing is', '{{AI_PDM_STATUS}}'],
  ],
  'ppt/slides/slide4.xml': [
    ['Overall EDI SIT testing is', '{{AI_EDI_STATUS}}'],
  ],
  'ppt/slides/slide5.xml': [
    ['Overall Enrollment SIT testing is', '{{AI_ENROLLMENT_STATUS}}'],
  ],
};
